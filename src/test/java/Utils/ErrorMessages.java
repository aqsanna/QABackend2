...
public class ErrorMessages {
    ...
    public static  String messageForPackInvalidCred = "Please fix the following errors: Box Name cannot be blank., Reserve (%) must be no less than 0., " +
            "Length must be no less than 9.0E-5., Width must be no less than 9.0E-5., Height must be no less than 9.0E-5., Weight must be greater than or equal to \"0\"., " +
            "Pack name cannot be blank., Price must be no less than 0., Free pack quantity must be no less than 0.";
    public static String messageForGiftCart = "Please fix the following errors: Initial Balance must be no less than 1.";
    ...
    public static Integer unprocessableStatusCode = 422;
}
